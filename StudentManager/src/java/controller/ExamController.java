 ...
 * @author mavjp
 */
public class ExamController extends BaseRequiredAuthenticationController {
    ...
    AssessmentDBContext dbAssess = new AssessmentDBContext();
    ...
    protected void processGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("assessments", dbAssess.list());
        request.setAttribute("exams", dbExam.list());
        request.getRequestDispatcher("view/exam.jsp").forward(request, response);
    }
